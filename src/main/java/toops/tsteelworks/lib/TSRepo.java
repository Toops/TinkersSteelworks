...
public class TSRepo {
	...
	public static final String MOD_REQUIRE = "required-after:Forge@[10.13.4.1448,);required-after:cookiecore@[1.4.0,);required-after:TConstruct;after:CoFHCore;after:NotEnoughItems;after:ExtraTic;after:MineTweaker3";
