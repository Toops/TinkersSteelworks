...
public class TSRepo {
	...
	public static final String MOD_REQUIRE = "required-after:Forge@[10.13,);required-after:cookiecore@[1.3.1,);required-after:TConstruct;after:CoFHCore;after:NotEnoughItems;after:ExtraTic;after:MineTweaker3";
