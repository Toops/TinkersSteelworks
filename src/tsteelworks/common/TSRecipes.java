...
public class TSRecipes
{
	...
	{
		final ItemStack is = new ItemStack(TSContent.materials, 1, 0);
		final FluidStack fs = new FluidStack(TContent.moltenStoneFluid, TConstruct.chunkLiquidValue / 4);
	...
	{
		final ItemStack bucket = new ItemStack(Item.bucketEmpty);
		TConstruct.tableCasting.addCastingRecipe(new ItemStack(TSContent.buckets, 1, 0), new FluidStack(TSContent.fluids[0],
				FluidContainerRegistry.BUCKET_VOLUME), bucket, true, 10);
	}
	...
	{
		final ItemStack is = new ItemStack(TSContent.highoven, 1, 2);
		final FluidStack fs = new FluidStack(TContent.moltenStoneFluid, TConstruct.chunkLiquidValue);
