...
public class TSRenderItemCopy extends Render
{
    ...
    public void doRenderItem (EntityItem par1EntityItem, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        {
            GL11.glPushMatrix();
            final float f2 = shouldBob() ? (MathHelper.sin(((par1EntityItem.age + par9) / 10.0F) + par1EntityItem.hoverStart) * 0.1F) + 0.1F : 0F;
            final float f3 = (((par1EntityItem.age + par9) / 20.0F) + par1EntityItem.hoverStart) * (180F / (float) Math.PI);
    ...
    public void renderItemAndEffectIntoGUI (SmallFontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5)
    {
        if (par3ItemStack != null)
            if (!ForgeHooksClient.renderInventoryItem(renderBlocks, par2TextureManager, par3ItemStack, renderWithColor, zLevel, par4, par5))
    ...
    public void renderItemIntoGUI (SmallFontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5, boolean renderEffect)
    {
        ...
        else
        {
            ...
            renderIcon(par4, par5, (Icon) object, 16, 16);
            GL11.glEnable(GL11.GL_LIGHTING);
    ...
    public void renderItemOverlayIntoGUI (SmallFontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5, String par6Str)
    {
        if (par3ItemStack != null)
        {
            ...
            {
                final int k = (int) Math.round(13.0D - ((par3ItemStack.getItemDamageForDisplay() * 13.0D) / par3ItemStack.getMaxDamage()));
                final int l = (int) Math.round(255.0D - ((par3ItemStack.getItemDamageForDisplay() * 255.0D) / par3ItemStack.getMaxDamage()));
                GL11.glDisable(GL11.GL_LIGHTING);
                GL11.glDisable(GL11.GL_DEPTH_TEST);
    ...
    private void renderDroppedItem (EntityItem par1EntityItem, Icon par2Icon, int par3, float par4, float par5, float par6, float par7, int pass)
    {
        ...
        if (renderManager.options.fancyGraphics)
        {
            ...
            for (int l = 0; l < par3; ++l)
            {
                ...
                if (l > 0)
                {
                    f11 = ((random.nextFloat() * 2.0F) - 1.0F) * 0.3F;
                    final float f16 = ((random.nextFloat() * 2.0F) - 1.0F) * 0.3F;
                    final float f17 = ((random.nextFloat() * 2.0F) - 1.0F) * 0.3F;
