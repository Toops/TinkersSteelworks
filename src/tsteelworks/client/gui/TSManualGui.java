...
public class TSManualGui extends GuiScreen
{
    ...
    public void initGui ()
    {
        ...
        this.buttonList.add(this.buttonNextPage = new TSTurnPageButton(1, xPos + bookImageWidth - 50, 180, true));
        this.buttonList.add(this.buttonPreviousPage = new TSTurnPageButton(2, xPos - bookImageWidth + 24, 180, false));
    }
    ...
    void updateText ()
    {
        ...
        if (node.getNodeType() == Node.ELEMENT_NODE)
        {
            ...
            Class clazz = TSClientProxy.getPageClass(element.getAttribute("type"));
            if (clazz != null)
            {
                try
                {
