...
public class TSToolPage extends TSBookPage
{
    String title;
    ItemStack[] icons;
    String[] iconText;
    ...
    public void readPageFromXML (Element element)
    {
        ...
        for (int i = 0; i < nodes.getLength(); i++)
        {
            ...
            icons[i + 1] = TSClientRegistry.getManualIcon(children.item(3).getTextContent());
        }
    ...
    public void renderContentLayer (int localWidth, int localHeight)
    {
        ...
        final int size = iconText[0].length() / 48;
        ...
        for (int i = 1; i < icons.length; i++)
        {
            ...
            final int partOffset = iconText[i + 1].length() > 11 ? -3 : 0;
