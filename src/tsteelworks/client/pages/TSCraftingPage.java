    ...
    public void drawCraftingPage (String info, ItemStack[] icons, int recipeSize, int localWidth, int localHeight)
    {
        ...
        if (recipeSize == 2)
        {
            ...
            for (int i = 0; i < (icons.length - 1); i++)
                if (icons[i + 1] != null)
                    manual.renderitem.renderItemAndEffectIntoGUI(manual.fonts, manual.getMC().renderEngine, icons[i + 1], (localWidth + 14 + (36 * (i % 2))) / 2,
                            (localHeight + (36 * (i / 2)) + 52) / 2);
        }
        ...
        if (recipeSize == 3)
        {
            ...
            for (int i = 0; i < (icons.length - 1); i++)
                if (icons[i + 1] != null)
                    manual.renderitem.renderItemAndEffectIntoGUI(manual.fonts, manual.getMC().renderEngine, icons[i + 1], ((localWidth - 2) + (36 * (i % 3))) / 2,
                            (localHeight + (36 * (i / 3)) + 34) / 2);
        }
