...
public class TSFilledBucket extends FilledBucket
{
	...
	{
		if (!world.isAirBlock(clickX, clickY, clickZ) && world.getBlockMaterial(clickX, clickY, clickZ).isSolid()) return false;
		else
		{
			try
			{
				int metadata = 0;
				if (TSContent.fluidBlocks[type] instanceof BlockFluidFinite) metadata = 7;
	...
	public static final String[]	materialNames	= new String[] { "MonoatomicGold" };
	public static final String[]	textureNames	= new String[] { "monoatomicgold" };
}
