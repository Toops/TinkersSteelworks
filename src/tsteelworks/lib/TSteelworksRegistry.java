...
public class TSteelworksRegistry
{
	...
	public static void addItemToDirectory (String name, Item itemstack)
	{
		...
		if (add != null) logger.warning(name + " is already present in the Item directory");
	...
	public static Item getItem (String name)
	{
		...
		if (ret == null) logger.warning("Could not find " + name + " in the Item directory");
		return ret;
	}
	...
	public static void addItemStackToDirectory (String name, ItemStack itemstack)
	{
		...
		if (add != null) logger.warning(name + " is already present in the ItemStack directory");
	...
	public static ItemStack getItemStack (String name)
	{
		...
		if (ret == null) logger.warning("Could not find " + name + " in the ItemStack directory");
		return ret;
	}
}
